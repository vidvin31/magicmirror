        ...
        <div class="hero-content">
            ...
            <div class="hero-title-wrap">
                <h1 class="hero-title">
                    ...
                    <span class="title-line reveal"><span>Mirror</span></span>
                </h1>
            </div>
            <div class="hero-tagline reveal">
                <div class="tagline-line"></div>
                <span>Makeover Studio</span>
                <div class="tagline-line"></div>
            </div>
            <p class="hero-desc reveal">Where artistry meets transformation. Premium beauty experiences crafted to reveal your most radiant self.</p>
        ...
        <div class="container">
            <div class="about-layout">
                    ...
                    <div class="about-visual reveal">
                        <div class="about-card-stack">
                            ...
                            <div class="about-card-main">
                                <img src="logo-pink.png" alt="Magic Mirror" class="about-card-logo">
                ...
                <div class="about-right">
                    ...
                    <p class="about-desc reveal">At Magic Mirror Makeover Studio, we believe every person deserves to feel confident and radiant. Our team of expert stylists, makeup artists, and beauty consultants craft looks that are uniquely yours.</p>
                    <p class="about-desc reveal">With years of mastering the art of beauty — from bridal glamour to everyday elegance — we blend artistry with the latest trends to create something truly magical.</p>
                    <div class="stats-row reveal">
                        <div class="stat-item">
                            <span class="stat-num" data-target="2500">0</span><span class="stat-plus">+</span>
                        ...
                        <div class="stat-item">
                            ...
                            <span class="stat-text">Expert Artists</span>
                        </div>
                        <div class="stat-divider"></div>
                        <div class="stat-item">
                            <span class="stat-num" data-target="50">0</span><span class="stat-plus">+</span>
                            <span class="stat-text">Services</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section services" id="services">
        <div class="container">
            ...
            <div class="bento-grid">
                <div class="bento-card bento-large reveal" data-tilt>
                    ...
                    <div class="bento-content">
                        ...
                        <p>Your dream bridal look — meticulously crafted for your most unforgettable day. From trials to the final reveal.</p>
    ...
    <section class="section gallery" id="gallery">
        <div class="container">
            ...
            <div class="gallery-mosaic">
                <div class="mosaic-item mosaic-tall reveal">
                    <div class="mosaic-inner">
                        <div class="mosaic-overlay">
                            <span class="mosaic-cat">Bridal</span>
                            <h4>Elegant Bridal Look</h4>
                        </div>
                    </div>
                </div>
                <div class="mosaic-item reveal">
                    <div class="mosaic-inner">
                        <div class="mosaic-overlay">
                            <span class="mosaic-cat">Glam</span>
                            <h4>Evening Glamour</h4>
                        </div>
                    </div>
                </div>
                <div class="mosaic-item reveal">
                ...
                <div class="mosaic-item mosaic-wide reveal">
                    <div class="mosaic-inner">
                        <div class="mosaic-overlay">
